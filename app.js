...
//     return result
// }
// document.write(power(4,2))

// ------------------2--------------------

// function leap(user_ip) {
...
// var user = +prompt("Enter any year??", 2003)
// leap(user)
...
// function area(a,b,c){
//     var area_s = s(a,b,c);
//     var final_area= area_s*(area_s - a)*(area_s - b)*(area_s - c)
//     return final_area;
// }


// document.write("The area of triangle is ",area(4,5,6))
...
//     var percentage = perc(a, b, c);
//     document.write("The average marks are " + average + " and the percentage is " + percentage.toFixed(2) + "%")
// }

// // assuming 100 marks for each subject
// main(56, 70, 98) 

// ------------------5--------------------

// function indexof_custom(str,char){
//     for (var i =0 ;i<str.length;i++){
//         if(char===str[i]){
//             document.write("The index of   "+char+" in the string "+str+" is "+i)
//         }

//     }
// }
// indexof_custom("dragon","a")
// ------------------6--------------------

// function del(string){
//     var string_1 = string.replace( /[aeiou]/g, '' );
//     document.write(string_1)
// }

// del("The string to test vowels")


// ------------------7--------------------
// function vowelOccurrences(string) {
//     var str = string;
...
//         var char = chars[i];
//         var next = chars[i + 1];
//         if (checkCharacter(char) && checkCharacter(next)) {
//             count++
//         }
//     }
//     return count;
...
// document.write(vowelOccurrences("Please read this application and give me gratuity"))
...
//     return result
// }
// function centimeter(ip){
//     var result = ip*100000
//     return result
// }

// var distance = +prompt("Enter distance between two cicities in km??")
// document.write("The distance in meters is ", meters(distance));
// document.write("<br> The distance in inches is ",inches(distance));
// document.write("<br> The distance in centimeters is ",centimeter(distance));
// document.write("<br> The distance in feet is ",feet(distance));

// ------------------9--------------------
// function calcOvertimePay(a){
//     if (a<40){
//         document.write("you have not done overtime.")
//     }else{
//         var totalPay= a*12;
//         document.write("your overtime pay is "+totalPay+" Rs")
//     }
// }

// calcOvertimePay(+prompt("Enter hours worked??"))


// ------------------ 10 -------------------
// function totalCurrencyNotes(num) {
//     var rupees = num;
//     var strRupees = rupees.toString()

//     if (rupees < 100) {
//         if (rupees === 50) {
//             document.write("you will have one Fifty Rs note.")
//         } else if (rupees < 50) {
//             document.write("you will have " + strRupees[0] + " Ten Rs notes.")
//         } else {
//             var remaining = rupees - 50
//             var strRemaining = remaining.toString()
//             document.write("you will have one fifty Rs note and " + strRemaining[0] + " ten Rs notes.")
//         }

//     } 
//     else if (rupees === 100) {
//         document.write("you will have one  hundred Rs note.")
//     }
//     else if (rupees>100){
//         var convertInt = parseInt(strRupees[0])
//         var remainingAmout = rupees - ( convertInt  * 100)
//         var strAmount = remainingAmout.toString()
//         if (remainingAmout > 50) {
//             var remaining = remainingAmout - 50
//             var conStr = remaining.toString()
//             document.write("you will have " + strRupees[0] + " hundred Rs notes ," + " one fifty Rupees note and " + conStr[0] + " ten Rs notes")
//         } 
//         else if (remainingAmout < 50){
//             document.write("you will have " +strRupees[0] + " hundred Rs notes ," + strAmount[0] + " ten Rs notes")

//         }

//     }
// }
// var user = +prompt("Enter amount to withdraw??")
// totalCurrencyNotes(user)
...
// function del(num){
//     var extract = num.slice(-1)
//     console.log(extract)
//     var name="row";
//     var setLength = name+extract.toString();
//     var total=parseInt(extract)+1;  
//     document.getElementById(setLength).remove();
//     for(var i =total ; i<=9;i++){
//         var string = i.toString();
//         var newIndex = name+string;
//         var row = document.getElementById(newIndex).childNodes[0].innerHTML;
//         document.getElementById(newIndex).childNodes[0].innerHTML=row-1;
//     }  
// }
...
// function inc(){
//     numb++
//     document.getElementById("uniq").innerText= numb;
// }
// function dec(){
//     numb--
//     document.getElementById("uniq").innerText = numb;
...
//     document.write("<br> your email : ",email)
//     document.write("<br> your password : ",password)
// }

// ------------------2--------------------
// function readMore(){
//     var text = "Height: 16.2cm / 162.0 mm <br> Width: 7.61cm / 76.1mm <br>  Thickness: 0.83cm / 8.3mm <br>  Weight: About 188g <br> Color: Fluorite Purple, Marble Green <br> Operating System: ColorOS 6, based on Android 9 <br>Processor: MTK MT6771V(P70)<br>Battery: 4020mAh(TYP), 3910mAh(MIN) <br> RAM: 4GB/ 6GB <br>Storage: 64GB/ 128GB <br>"
//     var newpara = document.getElementById("details");
...
//  var elementsVariable = document.getElementById("main-content");
//  var elements = elementsVariable.getElementsByTagName("p");
//  console.log(elementsVariable)

//--------- ii -------------

//  var elementsVariable = document.getElementById("main-content").childNodes;
...
// var elementsVariable = document.getElementsByClassName("render");
// for(i=0; i<elementsVariable.length;i++){
//     console.log(elementsVariable[i].innerHTML)
...
//  var elementsVariable = document.getElementById("first-name");
// elementsVariable.value=elementsVariable.innerHTML = "Aasia"


//-------- -v -------------

// var elementsVariable = document.getElementById("last-name");
// elementsVariable.value=elementsVariable.innerHTML = "fayyaz";
// var elementsVariable = document.getElementById("email");
// elementsVariable.value=elementsVariable.innerHTML = "aasiafayyaz89@gmail.com";
...
// var elementsVariable = document.getElementById("form-content").nodeType;
// document.write(elementsVariable)

// ----------------- ii --------------------

// var elementsVariable = document.getElementById("lastName").nodeType;
// document.write(elementsVariable)

// ----------------- iii --------------------

// lastName has no child node.
// ----------------- iv --------------------


// var elementsVariable = document.getElementById("form-content");
// var child = elementsVariable.firstChild;
// document.write(child)
// var lastChild = elementsVariable.lastChild;
// document.write(lastChild)

// ----------------- v --------------------
// var elementsVariable = document.getElementById("lastName");
// var preSibling = elementsVariable.previousSibling;
// document.write(preSibling);
// var nextSibling = elementsVariable.nextSibling;
// document.write(nextSibling);


// ----------------- vi --------------------

// var elementsVariable = document.getElementById("email");
// var parent  = elementsVariable.parentNode;
// var node = elementsVariable.nodeType;
// document.write("parentnode is : ",parent)
// document.write("nodetype is : ",node)
